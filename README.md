...
This clock has 3 keys to set hours, minutes and seconds and used a DS1307 Serial Real-Time Clock to measure time. It also has the ability to display the clock in (12-24) hours.
